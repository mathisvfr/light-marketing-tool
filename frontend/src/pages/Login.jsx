    ...
    <main className="grid min-h-screen grid-cols-1 lg:grid-cols-2">
      ...
      <div className="relative hidden flex-col justify-between bg-sidebar p-12 text-white lg:flex">
        ...
        <div className="max-w-md">
          <p className="text-xs font-display font-bold uppercase tracking-[0.14em] text-white/70">
            Marketing tool
          </p>
          ...
          <p className="mt-4 text-base text-white/80">
            Vacatures en marketingcontent voor Light Personeelsdiensten — snel
            opgesteld, op merk, klaar om te publiceren.
          </p>
        </div>
        <div
          className="absolute right-0 bottom-0 h-2 w-40 bg-primary"
      ...
      {/* Form panel */}
      <div className="flex items-center justify-center bg-grey-50 px-4 py-12">
        <form

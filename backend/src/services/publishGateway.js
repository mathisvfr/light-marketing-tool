...
// in services/publication.js (Buffer for social, website stub for blogs pending
// the new own-site integration, XML feed for vacatures via Multiposter).
// This is NOT an n8n integration; no webhooks are called.
